...
function RadioGroupItem({
  ...
  return (
    <RadioGroupPrimitive.Item
      className={cn(
        "border-black dark:border-white bg-white dark:bg-black aspect-square size-4 shrink-0 items-center justify-center rounded-full border shadow-sm shadow-black/5",
        Platform.select({
      ...
      {...props}
    >
      <RadioGroupPrimitive.Indicator className="size-2 rounded-full bg-black dark:bg-white" />
    </RadioGroupPrimitive.Item>
  );
}
